...
// TestBayMetaCols_ShowsIDOnlyWhenDifferent confirms the conditional
...
func TestBayMetaCols_ShowsIDOnlyWhenDifferent(t *testing.T) {
...
// TestFormatBayShow_IncludesIDWhenDifferent confirms bay ws show
